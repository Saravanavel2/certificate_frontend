...
const BENEFITS = [
    ...
    { icon: 'pi pi-shield',         text: '4-Layer Cryptographic Verification Audit',      color: '#2563EB', bg: 'rgba(37,99,235,0.10)',   border: 'rgba(37,99,235,0.22)'  },
    { icon: 'pi pi-qrcode',         text: 'Dynamic QR Code Embedding on Every Certificate', color: '#F59E0B', bg: 'rgba(245,158,11,0.12)',  border: 'rgba(245,158,11,0.25)' },
    { icon: 'pi pi-database',       text: 'Consortium Ledger Registry & Consensus',         color: '#059669', bg: 'rgba(5,150,105,0.10)',   border: 'rgba(5,150,105,0.22)'  },
];

...
const LandingPage = ({ onStartApp, user }) => {
    ...
    const features = [
        { img: '/ai_about.png', title: 'Predefined Templates', desc: 'Maintain brand uniformity and authenticity using fixed, pixel-perfect certificate design templates.', color: '#F59E0B' },
        { img: '/trust_about.png', title: 'Bulk CSV Mapping', desc: 'Upload spreadsheet recipient lists and map columns to template design fields in one simple step.', color: '#A855F7' },
        { img: '/security_about.png', title: '4-Layer Security', desc: 'Validate authenticity using QR codes, SHA-256 integrity check, steganographic data injection, and consortium ledger transactions.', color: '#2563EB' },
        { img: '/design_about.png', title: 'Consortium Consensus', desc: 'Broadcast certificate records instantly across all participating network nodes for immutable consensus validation.', color: '#059669' },
    ];
                ...
                <div style={{ maxWidth: 1100, margin: '0 auto' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 40 }}>
                        {[
                            ...
                            { step: '03', title: 'Bulk Generate', desc: 'CertLock generates all certificates as secure, signed PDFs and packages them into a single ZIP for instant download.', icon: 'pi-send', color: '#10B981' },
                        ].map((s, i) => (
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 32 }}>
                        ...
                        <div className="card-premium" data-aos="fade-right" style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', color: 'var(--text)' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
                                ...
                                <h3 style={{ fontSize: '1.2rem', fontWeight: 800, margin: 0, fontFamily: 'Outfit' }}>4-Layer Verification</h3>
                            </div>
                            ...
                            <p style={{ color: 'var(--text-secondary)', fontSize: '0.92rem', lineHeight: 1.6, marginBottom: 20 }}>
                                Our proprietary 4-layer audit (QR Anchor + Hash + Steganography + Registry) ensures every certificate is authentic and impossible to forge.
                            </p>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                                {['QR Code Visual Anchor', 'Cryptographic Fingerprint', 'Invisible Binary Metadata', 'Secure Registry Consensus'].map((t, i) => (
                ...
                <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: 32 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 12, alignItems: 'flex-end' }}>
                        <center> <div style={{ fontSize: '0.85rem', color: 'var(--text-muted)', fontWeight: 500 }}>
                            © 2026 Blockchain-Based Certificate Generation and Validation System
                        </div></center>
